    ...
    <View style={[styles.container, { paddingTop: topPad }]}>
      <View style={styles.inner}>
        ...
        <View style={styles.centerPillWrap}>
          ...
          <Pressable style={styles.avatarAbsolute} onPress={() => router.back()}>
            ...
            <View style={styles.flashBadge}>
              <Text style={styles.flashText} numberOfLines={1}>{theirName.toUpperCase()}</Text>
            </View>
          </Pressable>
        </View>
        ...
        <View style={styles.rightPill}>
          ...
          <Pressable style={styles.pillAction} onPress={() => router.push("/editor")}>
            <Feather name="edit" size={18} color="#3390ec" />
          </Pressable>
        </View>
      </View>
    </View>
...
const styles = StyleSheet.create({
  ...
  flashText: { color: "#ffffff", fontSize: 7, fontWeight: "800", fontFamily: "Inter_700Bold", letterSpacing: 0.4 },
